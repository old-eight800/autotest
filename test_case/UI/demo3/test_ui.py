...
def test_case(demo3cases, page: Page):
    caseno = list(demo3cases.keys())[0]
    descrption = dict(list(demo3cases.values())[0])["descrption"]
    test_step = list(demo3cases.values())[0]["test_step"]
    expect_result = dict(list(demo3cases.values())[0])["expect_result"]
    allure_title(caseno)
